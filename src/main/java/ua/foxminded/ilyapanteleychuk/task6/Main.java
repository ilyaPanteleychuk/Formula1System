...
import ua.foxminded.ilyapanteleychuk.task6.formatter.AbbreviationFormatter;
import ua.foxminded.ilyapanteleychuk.task6.formatter.ModelFormatter;
...
public class Main {
    ...
    public static void main(String[] args) {
        StartReaderImplementation startReader = new StartReaderImplementation();
